...
- **製品版**：Booth にて無料配布（応援版 300円 を併売、内容は無料版と完全に同一で純粋な寄付・応援枠）
- **おためし版（LE版）**：当初は機能制限版として無償配布し、フル機能版を500円で販売する予定だったが、方針転換により廃止。2026-07-07、GitHub公開に向けたリポジトリ整理の一環として作業ツリーから完全に除去し、`D:\Data\10_Projects\adobe_uxp\_archive\metsuke-le` にローカルバックアップとして保管（復活の予定なし）
